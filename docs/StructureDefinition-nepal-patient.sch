...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://fhir.mohp.gov.np/StructureDefinition/nepal-caste-ethnicity']) &lt;= 1">extension with URL = 'http://fhir.mohp.gov.np/StructureDefinition/nepal-caste-ethnicity': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.mohp.gov.np/StructureDefinition/nepal-palika-type']) &gt;= 1">extension with URL = 'http://fhir.mohp.gov.np/StructureDefinition/nepal-palika-type': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.mohp.gov.np/StructureDefinition/nepal-palika-type']) &lt;= 1">extension with URL = 'http://fhir.mohp.gov.np/StructureDefinition/nepal-palika-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
